...
public remote function Client.openSpreadsheetById(string spreadsheetId) returns Spreadsheet|error {
    boolean|error spreadSheetIdValidateResult = validateSpreadSheetId(spreadsheetId);
    if (spreadSheetIdValidateResult is error) {
       return spreadSheetIdValidateResult;
    } else {
